...
class Admin extends CI_Controller {
	...
	public function getListPendaftaran()
	{
		...
		if($this->input->post('keyword')){
			...
			$data = $this->Admin_model->getDataJoin("tbl_pendaftaran", "tbl_layanan", "tbl_layanan.id = tbl_pendaftaran.id_layanan", ["tbl_pendaftaran.tgl_kunjungan >=" => $today], $keyword, true);
		} else {
			$data = $this->Admin_model->getDataJoin("tbl_pendaftaran", "tbl_layanan", "tbl_layanan.id = tbl_pendaftaran.id_layanan", ["tbl_pendaftaran.tgl_kunjungan >=" => $today]);
		}
